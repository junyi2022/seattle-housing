...
Seattle_final <- st_drop_geometry(Seattle.sf_tracts2) %>%
  ...
  select(Age, price, bedrooms, bathrooms, sqft_living, waterfront, view, condition, grade, crime_count, hosp_nn1, school_count, parks_count, cross_count, canopy, TrafficDis, pctWhite,  MedIncome) %>% 
