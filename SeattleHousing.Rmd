...
Seattle_final <- st_drop_geometry(Seattle.sf_tracts2) %>%
  ...
  select(-zipcode, -quintiles, -crime.Buffer, -school.Buffer, -hosp.Buffer, -parks.Buffer, -id, -date, -starts_with("crime_nn"), -Age, -waterfront, -school_count, -parks_count, -bedrooms, -school_nn3, -school_nn4, -school_nn5, -hosp_nn2, -yr_renovated, -floors, -bathrooms, -price_per_sqft) %>% 
