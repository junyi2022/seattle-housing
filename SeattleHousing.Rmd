...
lm_cv <- train(price ~ sqft_living,  # Formula for the linear regression model
...
lm_loocv <- train(price ~ sqft_living,  # Formula for the linear regression model
                  data = Seattle_final,  # Dataset
                  method = "lm",           # Specify "lm" for linear regression
                  trControl = control)     # Use the defined control parameters
